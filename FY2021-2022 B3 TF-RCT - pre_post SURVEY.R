...
B3_2021_trct_var <- tag_gif_programs(B3_2021_trct_var,"gif","Transform RCT")
...
B3_2021_trct_mid_var <- tag_gif_programs(B3_2021_trct_mid_var,"gif","Transform RCT")
...
#******************************************************************************************************************************
# save raw data
B3_2021_trct_var <- flatten_lists_in_data(B3_2021_trct_var)
B3_2021_trct_mid_var <- flatten_lists_in_data(B3_2021_trct_mid_var)

write_csv(B3_2021_trct_var,file='G:/.shortcut-targets-by-id/0BwSiMwXYbhP-LUE0eW54TXl4RlE/ICM Research/0. Data/4.DataFusionProject/04 Working Drive/PrePost updated/4.FY202122/pre_post/B3_2021_trct_raw.csv')
write_csv(B3_2021_trct_mid_var,file='G:/.shortcut-targets-by-id/0BwSiMwXYbhP-LUE0eW54TXl4RlE/ICM Research/0. Data/4.DataFusionProject/04 Working Drive/PrePost updated/4.FY202122/pre_post/B3_2021_trct_mid_raw.csv')
...
B3_2021_pre_trct_clean <- tag_gif_programs(B3_2021_pre_trct_clean,"gif","Transform RCT")
...
B3_2021_mid_trct_clean <- tag_gif_programs(B3_2021_mid_trct_clean,"gif","Transform RCT")
#----------------------------------------------------------------------------------------------------------------
# prepost + Ops data
#pre
...
#matched
B3_2021_trct_prepost_matched <- prepost_match(B3_2021_pre_trct_clean,B3_2021_mid_trct_clean)
...
B3_2021_trct_prepost_matched_ops <- merge(B3_2021_trct_prepost_matched,ops_data, by = "hhid") 
...
b3_2021_trct_codebook <- bind_rows(b3_2021_pre_trct_codebook,b3_2021_POST_trct_codebook)
write_csv(b3_2021_trct_codebook,file='G:/.shortcut-targets-by-id/0BwSiMwXYbhP-LUE0eW54TXl4RlE/ICM Research/0. Data/4.DataFusionProject/04 Working Drive/PrePost updated/4.FY202122/PrePost_Codebook/b3_2021_trct_codebook.csv')
